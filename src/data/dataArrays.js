export const categories = [
  ...
  },
  {
    id: 5,
    name: 'Chinese Food',
    photo_url: 'https://media-cdn.tripadvisor.com/media/photo-s/14/4e/fb/96/prawns-with-veges-and.jpg'
  },
  {
  id: 6,
  name: 'Punjabi Food',
  photo_url: 'https://indiagateflours.com/superadmin/upload/blog/punjabi-recipes.jpg'
},
{
  id: 7,
  name: 'Turkish Food',
  photo_url: 'https://idsb.tmgrup.com.tr/ly/uploads/images/2022/06/10/211394.jpg'
},
{
  id: 8,
  name: 'Arabic Food',
  photo_url: 'https://images.aws.nestle.recipes/resized/10c05681081b47950fe2f90e73968e7d_Chicken-Mandi_944_531.jpg'
},
];
...
export const recipes = [
  ...
  },
  {
    ...
    photo_url: 'https://recipetineats.com/wp-content/uploads/2019/12/Christmas-Cookies-Sugar-Cookies_7.jpg',  // Replace with an actual photo URL
    photosArray: [
      'https://www.example.com/christmas-cookies1.jpg',
      'https://www.example.com/christmas-cookies2.jpg',
      'https://www.example.com/christmas-cookies3.jpg'
    ],
    time: '60',
    ingredients: [
      [1, '2 cups'],
    ...
    description:
      '-- Preheat the oven to 350°F. In a large bowl, cream together the butter, sugar, and brown sugar until smooth. Beat in the eggs one at a time, then stir in the vanilla.\n\n -- In a separate bowl, whisk together the flour, baking soda, salt, cinnamon, and nutmeg. Gradually add the dry ingredients to the wet ingredients and mix until just combined.\n\n -- Fold in the chocolate chips and chopped nuts. Drop rounded tablespoons of dough onto ungreased baking sheets.\n\n -- Bake for 10 to 12 minutes, or until edges are golden brown. Let cool on the baking sheets for a few minutes before transferring to wire racks to cool completely. Enjoy your delicious Christmas cookies!'
},
{
  recipeId: 3,
  categoryId: 3,
  title: 'Gingerbread Cookies',
  photo_url: 'https://www.onceuponachef.com/images/2020/12/gingerbread-men-1200x800.jpg',  // Replace with an actual photo URL
  photosArray: [
    'https://www.example.com/gingerbread-cookies1.jpg',
    'https://www.example.com/gingerbread-cookies2.jpg',
    'https://www.example.com/gingerbread-cookies3.jpg'
  ],
  time: '90',
  ingredients: [
  ...
  description:
    ...
    '2. In a medium bowl, whisk together the flour, ground ginger, ground cinnamon, ground cloves, salt, and baking soda.\n\n' +
    '3. In a large bowl, cream together the softened butter, granulated sugar, molasses, egg, and vanilla extract until light and fluffy.\n\n' +
    '4. Gradually add the dry ingredients to the wet ingredients, mixing until a dough forms.\n\n' +
    '5. On a lightly floured surface, roll out the dough to about 1/4-inch thickness. Use cookie cutters to cut out shapes.\n\n' +
    '6. Place the cutout cookies on baking sheets lined with parchment paper.\n\n' +
    '7. Bake for about 10 to 12 minutes, or until the edges are slightly golden.\n\n' +
...

{
  ...
  photo_url: 'https://www.thecookierookie.com/wp-content/uploads/2018/04/strawberry-cake-mix-cookies-strawberry-cookies-3-of-6-500x375.jpg',  // Replace with an actual photo URL
  photosArray: [
    'https://www.example.com/strawberry-cookies1.jpg',
    'https://www.example.com/strawberry-cookies2.jpg',
    'https://www.example.com/strawberry-cookies3.jpg'
  ],
  time: '60',
  ingredients: [
    ...
    [8, '1/2 cup dried strawberries, chopped'],
  ...
  description:
    ...
    '6. Fold in the chopped dried strawberries and white chocolate chips.\n\n' +
    '7. Drop spoonfuls of cookie dough onto baking sheets lined with parchment paper.\n\n' +
    '8. Bake for about 10 to 12 minutes, or until the edges are golden.\n\n' +
...
},
{
  ...
  photo_url: 'https://food-images.files.bbci.co.uk/food/recipes/monster_cookies_63048_16x9.jpg',  // Replace with an actual photo URL
  photosArray: [
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQi97an2YCgPJ1RIUbA9ZsUvXMIbX3MbD0FJ7iCuDl32EkpsKT_N2q1WG2Vp9EbD97TJ2o&usqp=CAU',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9QlmQCf7LJ6emDnkhlY0Ux6UVJH94ErO3H1Msf2oz1Kp6VqcLoCy7G2jGDme2hd3Ij9k&usqp=CAU',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMz3wpjqz-WxEN6niWGtNdiWWbAR6zvsXSqnU_DN1wlX7HgCuhL72WVBQsBqHmEMPhb8g&usqp=CAU'
  ],
  time: '45',
  ingredients: [
      ...
      [6, '2 cups creamy peanut butter'],
      [7, '4 1/2 cups old-fashioned oats'],
      [8, '2 teaspoons baking soda'],
      [9, '1/2 teaspoon salt'],
      [10, '1 cup chocolate chips'],
      [11, '1 cup M&M\'s candies'],
      [12, '1/2 cup chopped nuts (optional)']
    
  ],
  description:
    '-- Preheat the oven to 350°F. In a large bowl, cream together the butter, granulated sugar, and brown sugar until light and fluffy. Beat in the eggs one at a time, then add the vanilla extract and peanut butter. Mix well.\n\n -- In a separate bowl, whisk together the oats, baking soda, and salt. Gradually add the dry mixture to the wet ingredients and mix until well combined.\n\n -- Fold in the chocolate chips, M&M\'s candies, and chopped nuts (if using). Drop spoonfuls of cookie dough onto baking sheets lined with parchment paper.\n\n -- Bake for about 10 to 12 minutes, or until the edges are golden. Let cool on the baking sheets for a few minutes before transferring to wire racks to cool completely. Enjoy your delightful Monster Cookies!'
},
